...
<script>
	...
	function contactRegFormCheck( ){
		...
		try{
			...
			// 만약 연락처명이 한글 또는 영어 또는 숫자가 아니면 경고하고, 지우고 ,함수 멈추기
...
<form name="contactRegForm" method="post"  action="erp/contactRegProc.do">
	...
	<span style="cursor:pointer" onclick="location.replace('/erp/contactSearchForm.do');">[연락처 목록으로]</span>
